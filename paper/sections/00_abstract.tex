...
resolution. Using a conservative annotation-based evaluation across a panel of
mammalian genomes, \curia{} identified short ncRNA loci; in the human-to-mouse
comparison, 53.1\% of predicted loci overlapped an annotated exon (any overlap).
It further uncovered ${\sim}700$ candidate intergenic loci potentially
