...
reference annotation is available), among 2{,}805 predicted short ncRNA loci
53.1\% show any overlap with an annotated exon ($\geq 1$\,nt; any-overlap rate),
47.7\% meet a reciprocal-overlap recovery criterion (predicted locus covering
$\geq 50\%$ of the annotated transcript), and 35.5\% meet near-complete boundary
recovery ($\geq 99\%$ overlap). Among any-overlap predictions, the median overlap
is 100\% (mean 88.8\%), indicating that matched loci are typically well
...
identify approximately 700 candidate intergenic loci potentially corresponding to
conserved ncRNA elements, exhibiting consistent embedding-space similarity across
$\geq 9$ species. The full set of
...
performed on GPU with batched execution, while
