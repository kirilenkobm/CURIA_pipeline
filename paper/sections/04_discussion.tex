...
% TODO(authors): add \cite keys for slncky (Chen et al., Genome Biol. 2016) and
% lncHOME to CURIA_Preprint.bib, then cite them on the sentence above. No bib
% entries currently exist; not fabricating citation metadata here.
